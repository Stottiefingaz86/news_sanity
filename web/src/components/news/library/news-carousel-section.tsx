...
export const NewsCarouselSection = forwardRef<HTMLElement, NewsCarouselSectionProps>(
  function NewsCarouselSection(
    { title, kicker, articles, variant = "cards", className },
    ref,
  ) {
    if (!articles.length) return null;

    return (
      <section ref={ref} className={cn("my-10", className)}>
